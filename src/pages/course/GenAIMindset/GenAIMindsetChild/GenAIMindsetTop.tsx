...
// export default function GenAIMindsetTop() {
...
// }
import { createUseStyles } from "react-jss";
import book from "../../../../assets/Mindset.jpg";
...
export default function LandingSlide() {
  ...
  return (
    <div className={classes.container}>
      <h1 className={classes.heading}>Cultivating AI/GenAI Mindset</h1>
    </div>
  );
}
